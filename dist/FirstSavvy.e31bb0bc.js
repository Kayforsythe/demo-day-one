...
},{"buffer":"node_modules/buffer/index.js"}],"src/Navigation.js":[function(require,module,exports) {
"use strict";
...
function buildLink(link) {
  ...
  return (0, _litHtml.html)(_templateObject(), href, (0, _lodash.capitalize)(link));
}

function Navigation(state) {
  return "\n<div id=\"navigation\">\n <ul class = \"container\">\n    ".concat(state[state.active].links.map(buildLink).join(''), "\n    \n </ul>\n</div>  \n");
}
},{"lit-html":"node_modules/lit-html/lit-html.js","lodash":"node_modules/lodash/lodash.js"}],"src/Header.js":[function(require,module,exports) {
"use strict";
...
function Content(state) {
  return (0, _litHtml.html)(_templateObject(), Screens[state.active]());
}
